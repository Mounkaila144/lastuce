...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Mettre à jour les index (idempotent côté MySQL, tolérant côté SQLite tests).
        try {
            Schema::table('episodes', function (Blueprint $table) {
        ...
        // Migrer les données existantes (uniquement si les colonnes legacy existent).
        ...
        if (Schema::hasColumn('episodes', 'date_diffusion')) {
