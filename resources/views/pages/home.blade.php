        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="relative animate-scale-in animation-delay-600">
                <div class="relative rounded-2xl overflow-hidden shadow-2xl">
                    @php
                        // URL canonique de la vidéo (l'URL share/v/... ne fonctionne pas avec le plugin Facebook)
                        $featuredVideoUrl = 'https://www.facebook.com/light0n/videos/969393391299687/';
                        $featuredEmbedUrl = 'https://www.facebook.com/plugins/video.php?href=' . urlencode($featuredVideoUrl) . '&show_text=false&autoplay=false';
                    @endphp

                    <div class="aspect-video bg-gradient-to-br from-gray-900 to-gray-800 relative">
                        <!-- Lecteur Facebook -->
                        <iframe src="{{ $featuredEmbedUrl }}"
                                class="absolute inset-0 w-full h-full"
                                frameborder="0"
                                allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"
                                allowfullscreen="true"
                                scrolling="no"
                                title="{{ __('home.featured_video.title') }}"></iframe>

                        <!-- Informations vidéo -->
                        <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6 pointer-events-none">
                            ...
                            <!-- Badge Facebook -->
                            <div class="mt-3 flex items-center space-x-2 pointer-events-auto">
                                ...
                                <a href="{{ $featuredVideoUrl }}" target="_blank" rel="noopener"
                                   class="text-gray-300 hover:text-white text-xs transition-colors">
                                    {{ __('Voir sur Facebook') }}
                                </a>
                            </div>
                        </div>
                    </div>
