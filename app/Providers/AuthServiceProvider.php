...
class AuthServiceProvider extends ServiceProvider
{
    ...
    {
        // Les super-admins (role === 'admin') ont tous les droits
        // implicitement, sans avoir à maintenir une liste de permissions
        // dans le champ JSON.
        Gate::before(function ($user) {
            if ($user->isAdmin() && $user->hasRole('admin')) {
                return true;
            }
            return null; // continue vers les Gate::define ci-dessous
        });
